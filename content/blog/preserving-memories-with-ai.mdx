...
This is the problem our team set out to solve when we built [FuneratPhoto](/products/funeratphoto).

## The Technology Behind Compassionate AI

FuneratPhoto uses the same core restoration and enhancement technology that powers professional photo studios, but adapted specifically for memorial use cases.
...
We want to be explicit about this: **photographs submitted to FuneratPhoto are never stored, analyzed, or retained beyond the immediate processing session.**
...
The use of FuneratPhoto extends beyond immediate funeral needs. Families have used the tool to:
...
We designed FuneratPhoto to be invisible in its operation — a tool that simply makes a difficult task easier, without drawing attention to itself. There are no intrusive advertisements, no social sharing prompts, no unnecessary sign-up flows. You upload a photograph. You receive an enhanced photograph. That is the entire experience.

Because when someone is grieving, the last thing they need is friction.

## Using FuneratPhoto

FuneratPhoto is available on iOS and Android. To learn more about the tool and its capabilities, visit our [product page](/products/funeratphoto).
